...
-- Volcando estructura de base de datos para antonny
CREATE DATABASE IF NOT EXISTS `antonny` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `antonny`;

-- Volcando estructura para tabla antonny.agendas
...
-- Volcando datos para la tabla antonny.agendas: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.asistencias
...
-- Volcando datos para la tabla antonny.asistencias: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.cargos
CREATE TABLE IF NOT EXISTS `cargos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cargo` text COLLATE utf8mb3_spanish_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;

-- Volcando datos para la tabla antonny.cargos: ~14 rows (aproximadamente)

-- Volcando estructura para tabla antonny.copias
...
-- Volcando datos para la tabla antonny.copias: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.destinatarios
...
-- Volcando datos para la tabla antonny.destinatarios: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.firmantes
...
-- Volcando datos para la tabla antonny.firmantes: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.gacetas
...
-- Volcando datos para la tabla antonny.gacetas: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.miembros
CREATE TABLE IF NOT EXISTS `miembros` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tipo` varchar(100) COLLATE utf8mb3_spanish_ci NOT NULL,
  `cargos_id` int unsigned NOT NULL DEFAULT '0',
...
-- Volcando datos para la tabla antonny.miembros: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.resoluciones
...
-- Volcando datos para la tabla antonny.resoluciones: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.sellos
...
-- Volcando datos para la tabla antonny.sellos: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.sesiones
...
-- Volcando datos para la tabla antonny.sesiones: ~0 rows (aproximadamente)

-- Volcando estructura para tabla antonny.users
...
-- Volcando datos para la tabla antonny.users: ~2 rows (aproximadamente)
